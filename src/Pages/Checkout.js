                    ...
                    <form className='bg-white p-8'>
                        <div className="space-y-12 mt-5">
                            <div className="border-b border-gray-900/10 pb-12">
                                ...
                                <div className="border-b border-gray-900/10 pb-12 mt-7">
                                    ...
                                    <ul role="list" className="divide-y divide-gray-100">
                                        {addresses.map((address) => (
                                            <li key={address.email} className="flex justify-between gap-x-6 py-2 ">
                                                <div className="flex min-w-0 gap-x-6 border-solid border-2 border-gray-200">
                                                    <input
                                                        id="cash"
                                                        name="payment"
                                                        type="radio"
